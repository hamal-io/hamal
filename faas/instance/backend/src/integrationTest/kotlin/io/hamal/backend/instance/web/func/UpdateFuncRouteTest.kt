...
internal class UpdateFuncRouteTest : BaseFuncRouteTest() {
    ...
    fun `Updates func`() {
        ...
        val func = awaitCompleted(
            createFunc(
                CreateFuncReq(
                    ...
                    inputs = FuncInputs(DepTableType("hamal" to StringType("createdInputs"))),
        ...
        val updateFuncResponse = httpTemplate.put("/v1/funcs/{funcId}")
            ...
            .body(
                UpdateFuncReq(
                    ...
                    inputs = FuncInputs(DepTableType("hamal" to StringType("updatedInputs"))),
        ...
        with(getFunc(funcId)) {
            ...
            assertThat(inputs, equalTo(FuncInputs(DepTableType("hamal" to StringType("updatedInputs")))))
    ...
    fun `Updates func without updating values`() {
        ...
        with(getFunc(funcId)) {
            ...
            assertThat(inputs, equalTo(FuncInputs(DepTableType("hamal" to StringType("createdInputs")))))
