...
internal abstract class EthBaseTest {
    ...
    protected fun assertBlock0x100002(block: EthBlock?) {
        ...
        assertThat(block.hash, equalTo(EthHash("0x54dd95b568a08a6bcc3ad1675810b8ec841ef5eed7ac027cce35bb2a097671f9")))
        assertThat(
            block.logsBloom,
            equalTo(EthPrefixedHexString(""))
        )
        assertThat(block.miner, equalTo(EthAddress("0x2a65aca4d5fc5b5c859090a6c34d164135398226")))
        assertThat(block.mixHash, equalTo(EthHash("0x4e30728efe54a4f4dcee2760f8691058abf340e91f4cd2b9f86ca17cc4f32574")))
        assertThat(block.number, equalTo(EthUint64("0x100002")))
        assertThat(block.parentHash, equalTo(EthHash("0x18c68d9ba58772a4409d65d61891b25db03a105a7769ae08ef2cff697921b446")))
        assertThat(block.receiptsRoot, equalTo(EthHash("0x72bfd2b2b986dfbb904161426f2f9ab419e219174e41ab68baef84ecf64b2630")))
        assertThat(block.sha3Uncles, equalTo(EthHash("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347")))
        assertThat(block.size, equalTo(EthUint64("0x36f")))
        assertThat(block.stateRoot, equalTo(EthHash("0xb3b2f5293097b39ad903df8ba0a17c04832b2d6a7fff3c3c3dd6afe2dbfa96d7")))
        assertThat(block.timestamp, equalTo(EthUint64("0x56cc7ba8")))
        assertThat(block.totalDifficulty, equalTo(EthUint256("0x6babaca3ae996bed")))
    ...
    protected fun assertTransaction0x7da0e4de6f6f08c3e103d8a9fbb8906963b2547af0431d28aec866f7bbbdec5d(tx: EthTransaction) {
        assertThat(tx.blockHash, equalTo(EthHash("0x54dd95b568a08a6bcc3ad1675810b8ec841ef5eed7ac027cce35bb2a097671f9")))
        assertThat(tx.blockNumber, equalTo(EthUint64("0x100002")))
        assertThat(tx.from, equalTo(EthAddress("0x33357e443d5f03882af49bdcc62ca364ee0a6c7b")))
        assertThat(tx.gas, equalTo(EthUint64("0x5208")))
        assertThat(tx.gasPrice, equalTo(EthUint64("0xba43b7400")))
        assertThat(tx.maxPriorityFeePerGas, nullValue())
        assertThat(tx.maxFeePerGas, nullValue())
        assertThat(tx.hash, equalTo(EthHash("0x7da0e4de6f6f08c3e103d8a9fbb8906963b2547af0431d28aec866f7bbbdec5d")))
        assertThat(tx.input, equalTo(EthPrefixedHexString("0x")))
        assertThat(tx.nonce, equalTo(EthUint64("0xe")))
        assertThat(tx.to, equalTo(EthAddress("0x181A54307dD7075a6D628014a59c1E48D1D4d2A0")))
        assertThat(tx.transactionIndex, equalTo(EthUint32("0x1")))
        assertThat(tx.value, equalTo(EthUint256("0xdaf134736c65000")))
        assertThat(tx.type, equalTo(EthUint8("0x0")))
