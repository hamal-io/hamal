...
export type ControlType = 'Condition' | 'Input' | 'Init' | 'Invoke' | 'InputString'

export type Control = ControlCondition | ControlInput | ControlInit | ControlInvoke | ControlText
