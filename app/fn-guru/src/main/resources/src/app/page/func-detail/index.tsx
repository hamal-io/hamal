...
type TabType = 'Dashboard' | 'Editor' | 'Trigger' | 'Execution' | 'Settings'
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-row ">
                <Button onClick={() => {
                    updateFunction(props.funcId, {name: null, code: props.code}).then(response => {
        ...
        <main className="flex-1 w-full mx-auto text-lg h-full shadow-lg bg-gray-100">
            ...
            <div>
                ...
                <div className="p-4 sm:ml-64">
                    ...
                    {activeTab === 'Execution' && <h1> Execution</h1>}
