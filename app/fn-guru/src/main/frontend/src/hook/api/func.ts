...
import {ApiFunc, ApiFuncSimple, VersionedCode} from "@/api/types";
...
type ApiFuncGetAction = (funcId: string, controller?: AbortController) => void
export const useApiFuncGetAction = (): [ApiFuncGetAction, ApiFunc, boolean, Error] => {
    const [auth, setAuth] = useAuth()

    const [data, setData] = useState<ApiFunc | null>(null);
