...
import {useApiLoginAccount, useApiNamespaceCreate, useApiPost} from "@/hook";
...
const Create = () => {
    ...
    const [createNamespace, submittedNamespace] = useApiNamespaceCreate()
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            This is the name of your namespace.
                                        </FormDescription>
                                        <FormMessage/>
                                    </FormItem>
                                )}
