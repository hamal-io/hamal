...
//                     <CreateFunctionModalButton namespaceId={namespaceId}/>
//                 </div>
//             </section>
//
...
//
//
// const CreateFunctionModalButton = ({namespaceId}: { namespaceId: string }) => {
//     const navigate = useNavigate()
...
//     useEffect(() => {
//         if (data != null) {
//             navigate(`/namespaces/${namespaceId}/functions/${data.funcId}`)
...
//                         post(`v1/namespaces/${namespaceId}/funcs`, {name, inputs: {}, code: ""})
