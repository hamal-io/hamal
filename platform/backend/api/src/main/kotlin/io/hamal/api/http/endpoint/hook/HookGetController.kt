...
@RestController
internal class HookGetController(private val getHook: GetHookPort) {

    @GetMapping("/v1/hooks/{hookId}")
    fun getHook(@PathVariable("hookId") hookId: HookId): ResponseEntity<ApiHook> = getHook(hookId, ::assemble)
