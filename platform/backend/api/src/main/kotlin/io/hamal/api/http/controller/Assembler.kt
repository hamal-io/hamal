...
fun Requested.toApiRequested(): ApiRequested = when (this) {
    ...
    is BlueprintCreateRequested -> ApiBlueprintCreateRequested(id, status, blueprintId)
    ...
    is NamespaceAppendRequested -> ApiNamespaceCreateRequested(id, status,  namespaceId, workspaceId)
