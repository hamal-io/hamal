...
private fun FuncDeployLatestHandler.deployLatestVersion(req: FuncDeployLatestSubmitted): Func {
    return funcRepository.deployLatest(req.funcId, req.cmdId())
}

private fun FuncDeployLatestHandler.emitEvent(cmdId: CmdId, func: Func) {
