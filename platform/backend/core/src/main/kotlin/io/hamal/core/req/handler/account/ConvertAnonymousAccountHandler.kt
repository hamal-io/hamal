...
@Component
class ConvertAnonymousAccountHandler(
...
private fun ConvertAnonymousAccountHandler.convertAccount(req: AccountConvertSubmitted): Account {
...
private fun ConvertAnonymousAccountHandler.createPasswordAuth(req: AccountConvertSubmitted): Auth {
...
private fun ConvertAnonymousAccountHandler.createTokenAuth(req: AccountConvertSubmitted): Auth {
    return authCmdRepository.create(
...
private fun ConvertAnonymousAccountHandler.emitEvent(cmdId: CmdId, account: Account) {
