...
import io.hamal.core.adapter.exec.AppendExecLog
...
@RestController
internal class AppendExecLogController(private val appendExecLog: io.hamal.core.adapter.exec.AppendExecLog) {
