...
import io.hamal.lib.nodes.compiler.graph.DeprecatedGraphCompilerImpl
                ...
                try {
                    ...
                    when (unitOfWork.codeType) {
                        ...
                        CodeType(Nodes) -> {
                            ...
                            val compiledCode = DeprecatedGraphCompilerImpl(sandbox.generatorNodeCompilerRegistry).compile(graph)
