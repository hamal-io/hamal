...
root_namespace_funcs = fail_on_error(sys.funcs.list({ namespace_ids = { '1' } }))
assert(#root_namespace_funcs == 2)
assert(root_namespace_funcs[1].name == 'func-2')
assert(root_namespace_funcs[2].name == 'func-1')
