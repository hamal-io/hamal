...
func_req = fail_on_error(sys.func.create({ flow_id = flow_req.flow_id, name = 'test-func'; inputs = {}; code = [[4 + 2]] }))
sys.await_completed(func_req)

topic_req = fail_on_error(sys.topic.create({ flow_id = flow_req.flow_id, name = "some-amazing-topic" }))
sys.await(topic_req)
