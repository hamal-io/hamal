...
//    val arr = this
//    return KuaArray(
//        arr.mapIndexed { index, item -> (index + 1) to item.convertToType() }.toMap().toMukuaTableMap()
//    )
//}
...
//    return KuaTable(
//        obj.entrySet().associate { (key, item) -> key to item.convertToType() }.toMukuaTableMap()
//    )
    TODO()
}
