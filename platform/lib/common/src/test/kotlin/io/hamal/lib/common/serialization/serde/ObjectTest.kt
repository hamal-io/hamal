...
internal class SerdeObjectTest {

    @TestFactory
    fun `is`() = listOf(
        Tuple3("isArray", SerdeObject.empty.isArray, false),
        Tuple3("isBoolean", SerdeObject.empty.isBoolean, false),
        Tuple3("isNumber", SerdeObject.empty.isNumber, false),
        Tuple3("isNull", SerdeObject.empty.isNull, false),
        Tuple3("isObject", SerdeObject.empty.isObject, true),
        Tuple3("isString", SerdeObject.empty.isString, false),
        Tuple3("isTerminal", SerdeObject.empty.isPrimitive, false)
    ...
    inner class AsTest {
        ...
        @TestFactory
        fun `as`() = listOf(
            Tuple3("asArray", testInstance.asArray("array"), SerdeArray.builder().append(42).build()),
            Tuple3("asBoolean", testInstance.asBoolean("boolean"), SerdeBoolean(true)),
            Tuple3("asNumber", testInstance.asNumber("number"), SerdeNumber(123)),
            Tuple3("asNull", testInstance.asNull("null"), SerdeNull),
            Tuple3("asNull - does not found", testInstance.asNull("doesNotExist"), SerdeNull),
            Tuple3("asObject", testInstance.asObject("object"), SerdeObject.builder().set("hamal", "rocks").build()),
            Tuple3("asString", testInstance.asString("string"), SerdeString("SomeString")),
            Tuple3("asTerminal", testInstance.asTerminal("string"), SerdeString("SomeString")),
        ).map { (testName, result, expected) ->
            dynamicTest(testName) {
                assertThat(result, equalTo(expected))
            }
    ...
    @Test
    fun empty() {
        val testInstance = SerdeObject.empty
    ...
    inner class ContainsKeyTest {
        ...
        private val testInstance: SerdeObject = SerdeObject.builder().set("A", "b").build()
    }
    ...
    inner class FindTest {
        ...
        fun `Finds key`() {
            ...
            assertThat(result, equalTo(SerdeString("b")))
        }
    ...
    inner class DeepCopyTest {
        ...
        fun `Copy object`() {
            ...
            assertThat(result.asArray("array"), equalTo(SerdeArray.builder().append(42).build()))
            assertThat(result.asBoolean("boolean"), equalTo(SerdeBoolean(true)))
            assertThat(result.asNumber("number"), equalTo(SerdeNumber(123)))
            assertThat(result.asString("string"), equalTo(SerdeString("SomeString")))
            assertThat(result.asObject("object"), equalTo(SerdeObject.builder().set("hamal", "rocks").build()))
            assertThat(result.asNull("null"), equalTo(SerdeNull))
        }
    }
}

private val testInstance = SerdeObject.builder()
    .set("array", SerdeArray.builder().append(42).build())
    .set("boolean", true)
    .set("number", 123)
    .set("string", "SomeString")
    .set("object", SerdeObject.builder().set("hamal", "rocks").build())
    .setNull("null")
    .build()