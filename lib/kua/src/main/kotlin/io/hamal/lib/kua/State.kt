...
class ClosableState(
    ...
    override fun setGlobal(name: String, value: TableTypeMap) {
    ...
    override fun getGlobalTableMap(name: String): TableTypeMap {
    ...
    override fun tableCreateMap(capacity: Int): TableTypeMap {
