...
sealed interface FunctionOutputSchema<OUTPUT : FunctionOutput<*, *>> {
    val size: Int
    fun pushResult(ctx: Context, output: OUTPUT)
}

object FunctionOutput0Schema : FunctionOutputSchema<FunctionOutput0> {
    override val size = 0
    override fun pushResult(ctx: Context, output: FunctionOutput0) {}
}
...
data class FunctionOutput1Schema<ARG_1 : Value>(
    ...
    override val size = 1
    override fun pushResult(ctx: Context, output: FunctionOutput1<ARG_1>) {
...
data class FunctionOutput2Schema<ARG_1 : Value, ARG_2 : Value>(
    ...
    override val size = 2
    override fun pushResult(ctx: Context, output: FunctionOutput2<ARG_1, ARG_2>) {
        ctx.push(output.arg1)
