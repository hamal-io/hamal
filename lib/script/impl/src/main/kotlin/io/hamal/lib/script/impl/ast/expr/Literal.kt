...
data class NumberLiteral(val value: DepNumberValue) : LiteralExpression {
    constructor(value: Int) : this(DepNumberValue(value))
    ...
    internal object Parse : ParseLiteralExpression<NumberLiteral> {
        override fun invoke(ctx: Context): NumberLiteral {
            ...
            ctx.advance()
            return NumberLiteral(DepNumberValue(token.value))
        }
    }
