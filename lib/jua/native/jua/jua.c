...
#define JNLUA_JAVASTATE "jua.JavaState"
#define JNLUA_OBJECT "jua.Object"
...
#define JNI_LUASTATE_METHOD(x) LUASTATE_SUFFIX_CONCAT_INNER(Java_org_terasology_jua_LuaState,x,_,JNLUA_SUFFIX)
...
JNIEXPORT jint JNICALL JNI_OnLoad (JavaVM *vm, void *reserved) {
	...
	if (!(luastate_class = referenceclass(env, "org/terasology/jua/LuaState"))
	...
	if (!(luadebug_class = referenceclass(env, "org/terasology/jua/LuaState$LuaDebug"))
			|| !(luadebug_local_class = referenceclass(env, "org/terasology/jua/LuaState" AS_STR(JNLUA_SUFFIX) "$LuaDebug"))
	...
	if (!(javafunction_interface = referenceclass(env, "org/terasology/jua/JavaFunction"))
			|| !(invoke_id = (*env)->GetMethodID(env, javafunction_interface, "invoke", "(Lorg/terasology/jua/LuaState;)I"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luaruntimeexception_class = referenceclass(env, "org/terasology/jua/LuaRuntimeException"))
			|| !(luaruntimeexception_id = (*env)->GetMethodID(env, luaruntimeexception_class, "<init>", "(Ljava/lang/String;)V"))
			|| !(setluaerror_id = (*env)->GetMethodID(env, luaruntimeexception_class, "setLuaError", "(Lorg/terasology/jua/LuaError;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luasyntaxexception_class = referenceclass(env, "org/terasology/jua/LuaSyntaxException"))
			|| !(luasyntaxexception_id = (*env)->GetMethodID(env, luasyntaxexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luamemoryallocationexception_class = referenceclass(env, "org/terasology/jua/LuaMemoryAllocationException"))
			|| !(luamemoryallocationexception_id = (*env)->GetMethodID(env, luamemoryallocationexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luagcmetamethodexception_class = referenceclass(env, "org/terasology/jua/LuaGcMetamethodException"))
			|| !(luagcmetamethodexception_id = (*env)->GetMethodID(env, luagcmetamethodexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luamessagehandlerexception_class = referenceclass(env, "org/terasology/jua/LuaMessageHandlerException"))
			|| !(luamessagehandlerexception_id = (*env)->GetMethodID(env, luamessagehandlerexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luastacktraceelement_class = referenceclass(env, "org/terasology/jua/LuaStackTraceElement"))
			|| !(luastacktraceelement_id = (*env)->GetMethodID(env, luastacktraceelement_class, "<init>", "(Ljava/lang/String;Ljava/lang/String;I)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luaerror_class = referenceclass(env, "org/terasology/jua/LuaError"))
			|| !(luaerror_id = (*env)->GetMethodID(env, luaerror_class, "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V"))
			|| !(setluastacktrace_id = (*env)->GetMethodID(env, luaerror_class, "setLuaStackTrace", "([Lorg/terasology/jua/LuaStackTraceElement;)V"))) {
		return JNLUA_JNIVERSION;
	}
