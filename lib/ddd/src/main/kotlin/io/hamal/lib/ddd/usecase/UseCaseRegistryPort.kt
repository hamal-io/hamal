...
interface UseCaseRegistryPort {
    ...
    fun <RESULT : Any, USE_CASE : CommandUseCase> getCommandHandler(
        resultClass: Class<RESULT>,
        useCaseClass: Class<USE_CASE>
    ): CommandUseCaseHandler<RESULT, USE_CASE>

    fun <RESULT : Any, USE_CASE : QueryUseCase> getQueryHandler(
        resultClass: Class<RESULT>,
        useCaseClass: Class<USE_CASE>
    ): QueryUseCaseHandler<RESULT, USE_CASE>

    fun <RESULT : Any, USE_CASE : FetchOneUseCase> getFetchOneHandler(
        resultClass: Class<RESULT>,
        useCaseClass: Class<USE_CASE>
