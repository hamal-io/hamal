package io.hamal.lib.core.util.copy

import io.hamal.lib.core.ddd.base.ValueObject
import io.hamal.lib.core.util.Reflection
    ...
    inner class CopyTest {
        ...
        fun `Can not replace non nullable value with null value`() {
            ...
            assertThat(
                ...
                equalTo("Can not set final int field io.hamal.lib.core.util.copy.CopyTest\$CopyTest\$Can not replace non nullable value with null value\$SomeTarget.value to null value")
            )
        }
