package io.hamal.lib.domain.util.copy

import io.hamal.lib.domain.ddd.base.ValueObject
import io.hamal.lib.domain.util.Reflection
import io.hamal.lib.domain.util.copy.Copy
    ...
    inner class CopyTest {
        ...
        fun `Can not replace non nullable value with null value`() {
            ...
            assertThat(
                ...
                equalTo("Can not set final int field io.hamal.lib.domain.util.copy.CopyTest\$CopyTest\$Can not replace non nullable value with null value\$SomeTarget.value to null value")
            )
        }
