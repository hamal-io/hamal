...
include(":platform:runner:extension:std:algo")
...
include(":platform:runner:extension:std:once")
include(":platform:runner:extension:std:sys")
include(":platform:runner:extension:std:table")
include(":platform:runner:extension:std:throw")
include(":platform:runner:extension:social:telegram")
