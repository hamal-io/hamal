...
class NamedParametersIT {
    ...
    companion object {
        ...
        init {
            testStore.setupConnection(testStore.connection)
            testStore.setupSchema(testStore.connection)
        }
    }
...
//            execute("INSERT INTO boolean_table(value, another_value) VALUES(:true_value, :false_value)") {
            execute("INSERT INTO boolean_table(value, another_value) VALUES(?,?)") {
                set("true_value", true)
                set("false_value", false)
            }

//            testStore.connection.prepareStatement("INSERT INTO boolean_table(value, another_value) VALUES(?,?)").use {
...
//            }
//        }
//        testStore.jdbcOperations().jdbcOperations.update("INSERT INTO boolean_table(value, another_value) VALUES(true, false)")
