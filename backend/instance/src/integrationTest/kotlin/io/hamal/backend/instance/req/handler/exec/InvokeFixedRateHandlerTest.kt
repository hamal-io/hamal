...
internal class InvokeFixedRateHandlerTest : BaseReqHandlerTest() {
    ...
    @Test
    fun `Tries to invoke fixed rate execution but func does not exists`() {
    ...
    @Autowired
    private lateinit var testInstance: InvokeFixedRateHandler
