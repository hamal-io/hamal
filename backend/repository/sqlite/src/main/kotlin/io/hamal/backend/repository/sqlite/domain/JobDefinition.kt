...
class SqliteFuncRepository(config: Config) : BaseRepository(config), FuncCmdRepository {
...
//    }
    ...
    override fun execute(cmdId: CmdId, commands: List<Command>): List<Func> {
...
internal fun SqliteFuncRepository.insertFunc(cmdId: CmdId, toInsert: FuncToCreate) {
